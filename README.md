![Terkey Termux Key](screenshoot.jpg)
...
* `$ pkg install python`
* `$ pkg install git`
* `$ git clone https://github.com/AkhyarAzamta/terkey`
* `$ cd terkey`
* `$ python terkey.py`
...
```pkg update && pkg upgrade;pkg install python git;git clone https://github.com/AkhyarAzamta/terkey;cd terkey;python terkey.py```
...
> Thanks !
## Author
So many information about me in internet, just type ['Karjok Pangesty'](https://github.com/karjok/terkey) in your browser !
